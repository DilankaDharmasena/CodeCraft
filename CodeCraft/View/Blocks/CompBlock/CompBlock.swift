...
class CompBlock: UIView, Block {
    ...
    private func commonInit() {
        Bundle.main.loadNibNamed("CompBlock", owner: self, options: nil)
    ...
    @objc func handleSingleTap() {
        delegate.blockToBeEdited(id: blockID, data: [compLabel.text!])
    }
